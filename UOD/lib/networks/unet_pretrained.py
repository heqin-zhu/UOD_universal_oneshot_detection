...
class UNet_Pretrained(nn.Module):
    ...
    def forward(self, x, get_features=False, domain_idx=0):
        ...
        out_features = [fea_5, fea_4, fea_3, fea_2, fea_1, fea_0]
        if get_features:
            return fea_0, out_features
        else:
            return fea_0
...
if __name__ == '__main__':
    model = UNet_Pretrained(3, 19, emb_len=16)
